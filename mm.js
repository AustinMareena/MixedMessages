let randQuotes = ['Good, better, best. Never let it rest. Until your good is better and your better is best.', 'When something is important enough, you do it even if the odds are not in your favor.', 
...
function generateQuotes() {
    const quoteArray = [];
    for (let i = 0; i < 3; i++) {
        let index = Math.floor(Math.random() * randQuotes.length);
        quoteArray.push(randQuotes.splice(index, 1));
    }
